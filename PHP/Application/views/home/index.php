...
<!-- modals -->
<!-- Modal Login -->
<div class="modal fade modal-login" id="staticBackdropLogin" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          ...
          <div class="container ms-5 me-5">
            ...
            <form action="/user/login" method="post">
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingLoginUsername" placeholder="name@example.com">
        ...
        <div class="col-5 p-0 position-relative right-config">
          ...
          <div class="container d-flex justify-content-center top-40 position-absolute m-auto">
            <div class="modal-option">
              ...
              <div class="button d-flex justify-content-center mb-2 mt-4">
                <button class="bg-blue btn btn-form px-4" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdropLogon">Cadastre-se</button>
              </div>
            </div>
          </div>
...
<!-- Modal Sign in -->
<div class="modal fade modal-logon" id="staticBackdropLogon" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
        ...
        <div class="col-5 p-0 position-relative right-config">
          ...
          <div class="container d-flex justify-content-center top-40 position-absolute m-auto">
            <div class="modal-option">
              ...
              <div class="button d-flex justify-content-center mb-2 mt-4">
                <button class="bg-blue btn btn-form px-4" type="button"  data-bs-toggle="modal" data-bs-target="#staticBackdropLogin">Entrar</button>
              </div>
            </div>
          </div>
          <div class="background-style-down"></div>
